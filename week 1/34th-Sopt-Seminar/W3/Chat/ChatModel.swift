...
extension ChatModel {
    static func dummy() -> [ChatModel] {
        return [
            ...
            ChatModel(profileImg: .profile1, name: "김선우", place: "회기", message: "너무 좋아요", itemImg: .product4),
            ChatModel(profileImg: .profile1, name: "김나연", place: "미국", message: "뿅", itemImg: .product5),
            ...
            ChatModel(profileImg: .profile1, name: "한정원", place: "명왕성", message: "진짜?", itemImg: .product9),
            ChatModel(profileImg: .profile1, name: "이지훈", place: "안드로메다", message: "난이서~", itemImg: .product10)
        ]
    }
}
